const ADD_NEW_POINT = "ADD_NEW_POINT"
...
const mapReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        case ADD_NEW_POINT: {
            return { ...state, elements: [...state.elements, action.dataPoint] }
        }
        case REMOVE_POINT: {
            return { ...state, elements: [...action.newPoints] }
        }
        default:
            return state;
    }
...
export const addNewPoint = (dataPoint) => ({ type: ADD_NEW_POINT, dataPoint });

export const removePoint = (newPoints) => ({ type: REMOVE_POINT, newPoints })
